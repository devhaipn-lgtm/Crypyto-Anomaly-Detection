"""
Sentiment Producer (Docker version) - Fetches crypto news sentiment from
cryptonews-api.com and pushes to Kafka topic for correlation with trade data.

Uses container hostnames for Kafka.
...
def main():
    print("Starting Crypto Sentiment Producer (Docker/cryptonews-api.com)...")
